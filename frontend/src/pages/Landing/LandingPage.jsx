...
const FEATURE_CARDS = [
    {
        ...
        description: 'Log shifts, trips, gross income, deductions, and net received in one flow.',
        image: '/open_peeps/chillin.png'
    },
    {
        title: 'Evidence And Verification',
        description: 'Attach proof for sessions so verifiers can review transparently and quickly.',
        image: '/open_peeps/waiting.png'
    },
    {
        title: 'Worker-Focused Insights',
        description: 'Understand your trend and export reports for certificate and support use cases.',
...
const WORKFLOW_STEPS = [
    {
        ...
        description: 'Register, verify OTP, and complete profile with your worker category and location.'
    },
    {
        step: '2',
        title: 'Log Earnings',
        description: 'Add single sessions or bulk import CSV with clean, guided validation.'
    },
    {
        step: '3',
        title: 'Review And Improve',
        description: 'Use dashboards, community input, and insights to improve your weekly income.'
    }
];
            ...
            <main className="pt-24 pb-20">
                    ...
                    <div className="space-y-8">
                        ...
                        <div className="space-y-4">
                            ...
                            <p className="max-w-xl text-lg leading-relaxed text-zinc-600">
                                FairGig helps workers track session earnings, upload evidence, and build financial credibility through a clean, reliable workflow.
                            </p>
                        </div>
                    ...
                    <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-2">
                        {HERO_CARDS.map((card, index) => (
                            ...
                            >
                                ...
                                />
                                <p className="mt-3 text-center text-sm font-semibold text-zinc-700">{card.title}</p>
                            </div>
                        ))}
                    </div>
                </section>
                ...
                <section className="mx-auto mt-16 w-full max-w-7xl px-4 sm:px-6 lg:px-8">
                    <div className="grid gap-5 md:grid-cols-3">
                        {FEATURE_CARDS.map((feature) => (
                            <article key={feature.title} className="rounded-2xl border border-zinc-200 bg-white p-6 shadow-sm">
                                <img src={feature.image} alt={feature.title} className="mx-auto mb-4 h-28 w-full object-contain" />
                ...
                <section className="mx-auto mt-16 w-full max-w-7xl px-4 sm:px-6 lg:px-8">
                    <div className="rounded-3xl bg-zinc-900 px-6 py-12 text-white sm:px-10">
                        <div className="mb-8">
                            <h3 className="text-3xl font-black tracking-tight">How FairGig Works</h3>
                            <p className="mt-2 text-zinc-300">A focused flow built for workers and support teams.</p>
                        </div>

                        <div className="grid gap-6 md:grid-cols-3">
                            {WORKFLOW_STEPS.map((item) => (
                                <div key={item.step} className="rounded-2xl border border-zinc-700 bg-zinc-800/70 p-5">
